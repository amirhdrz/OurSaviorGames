package com.oursaviorgames.android.external.materialishprogress;
...
public class Spinner extends View {
    ...
    private static final float SIZE_LARGE_DIPS = 48.f;
    private static final float SIZE_SMALL_DIPS = 24.f;

    private static final float SIZE_BAR_WIDTH_LARGE_DIPS = 4.f;
    private static final float SIZE_BAR_WIDTH_SMALL_DIPS = 3.f;

    // Must match the values set in attrs.xml
    ...
    private int barColor = 0x42000000; // darkHighlight color.
    ...
    private void parseAttributes(TypedArray a) {
        ...
        setSize(a.getInt(R.styleable.ProgressWheel_size, Size_large));
        ...
        if (a.getBoolean(R.styleable.ProgressWheel_indeterminate, true)) {
            spin();
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        int viewWidth = circleRadius;
        int viewHeight = circleRadius;
    ...
    /**
     * One of the size values.
     * @param size One of Size_ values.
     */
    public void setSize(int size) {
        switch (size) {
            case Size_large:
                circleRadius = (int) convertDipToPx(SIZE_LARGE_DIPS);
                barWidth = (int) convertDipToPx(SIZE_BAR_WIDTH_LARGE_DIPS);
                rimWidth = (int) convertDipToPx(SIZE_BAR_WIDTH_LARGE_DIPS);
                break;
            case Size_small:
                circleRadius = (int) convertDipToPx(SIZE_SMALL_DIPS);
                barWidth = (int) convertDipToPx(SIZE_BAR_WIDTH_SMALL_DIPS);
                rimWidth = (int) convertDipToPx(SIZE_BAR_WIDTH_SMALL_DIPS);
                break;
        }
        if (!isSpinning) {
            invalidate();
